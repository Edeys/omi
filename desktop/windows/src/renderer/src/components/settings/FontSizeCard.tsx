...
export function FontSizeCard(): React.JSX.Element {
  ...
  return (
    <SettingRow
      ...
      subtitle={t('settings.general.fontSizeSubtitle', { percent: Math.round(scale * 100) })}
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <Slider
          ...
          step={0.05}
          tint="var(--info)"
          ariaLabel={t('settings.general.fontSizeTitle')}
        ...
        <p className="text-sm text-text-secondary">{t('settings.general.fontSizePreview')}</p>

        {/* Keyboard shortcut hints */}
        <div className="flex flex-col gap-1.5">
          <ShortcutHint label={t('settings.general.fontSizeIncrease')} keys={['Ctrl', '+']} />
          <ShortcutHint label={t('settings.general.fontSizeDecrease')} keys={['Ctrl', '−']} />
          <ShortcutHint label={t('settings.general.fontSizeResetHint')} keys={['Ctrl', '0']} />
        </div>
        ...
        <div>
          ...
          >
            ...
            {t('settings.general.fontSizeResetWindow')}
          </button>
        </div>
      </div>
    </SettingRow>
