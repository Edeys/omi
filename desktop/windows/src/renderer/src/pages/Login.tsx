  ...
  return (
    <div className="app-canvas relative flex h-full items-center justify-center p-8">
      <div className="animate-fade-in relative z-10 flex w-full max-w-[420px] flex-col items-center">
        ...
        <p className="mt-6 text-base leading-relaxed text-white/70">{t('login.signInSubtitle')}</p>
        <div className="h-48" />
        <button
          type="button"
        ...
        >
          ...
          {activeProvider === 'apple' ? t('login.tryAgain') : t('login.continueWithApple')}
        </button>
        <button
          type="button"
        ...
        >
          ...
          {activeProvider === 'google' ? t('login.tryAgain') : t('login.continueWithGoogle')}
        </button>
