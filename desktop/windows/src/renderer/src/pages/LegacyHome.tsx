...
// The original Home screen, kept behind the `useLegacyHomeDesign` preference so a
// user can switch back from the Hub. Moved here verbatim from pages/Home.tsx (which
